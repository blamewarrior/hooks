...
type PullRequestPublisher interface {
	PublishPullRequest(pullRequest *PullRequest) (err error)
}

type PullRequestPublishService struct {
...
func (service *PullRequestPublishService) PublishPullRequest(pullRequest *PullRequest) (err error) {
